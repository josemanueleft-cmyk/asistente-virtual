...
import {
  notificarPedidoDefinition,
  notificarPedidoHandler,
} from "./notificar-pedido";
...
const handlers: Record<string, GenericHandler> = {
  ...
  notificarPedido: (args) =>
    notificarPedidoHandler(args as unknown as Parameters<typeof notificarPedidoHandler>[0]),
};
