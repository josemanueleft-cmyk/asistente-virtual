...
// Punto de entrada público para que otras piezas (tools) manden un aviso al
// dueño reusando la MISMA conexión y el MISMO ALERT_WHATSAPP del watchdog, sin
// tener que pasarse el `sock` por toda la cadena de ejecución de tools.
export async function enviarAvisoDueno(text: string): Promise<boolean> {
